...
```{r}
x <- wrapr::build_frame(
  "Expert [reference]", "Letter", "Empasizes the importance of"|
  " ", " ", " "|
  "A. \\citet{Cairo:2019}", "______" , "message"|
  " ", " ", " "|
    
  "B. \\citet{Doumont:2009}", "______" , "variables"|
  " ", " ", " "|
    
  "C. \\citet{Evergreen:2017}", "______" , "revealing the complex"|
    " ", " ", " "|
    
  "D. \\citet{Tufte:1983}", "______" , "knowing your main point"|
  " ", " ", " "|
