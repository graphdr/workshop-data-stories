...
Before we can talk about what the chart *says*, we have to agree on what it *shows*. (*Data from:* [@Main+Wang+Tan:2021])
...
![](img/handout-01-15.png){width="140%"}
...
Match the expert to the advice (fill in the blanks with letters)

```{r}
x <- wrapr::build_frame(
  "Expert"              , "Letter", "Empasizes the importance of" |
  " ", " ", " " |
  "A. Alerto Cairo"     , "______" , "message"    |
  " ", " ", " " |
    
  "B. Jean-luc Doumont" , "______" , "variables"  |
  " ", " ", " " |
    
  "C. Stephanie Evegreen", "______" , "revealing the complex"|
    " ", " ", " " |
...
```
*Additional reading:*    
[@Cairo:2019], [@Doumont:2009], [@Evergreen:2017], [@Tufte:1983]
