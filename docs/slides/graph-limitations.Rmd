...
*Information.* Pick a color. Describe the information it encodes.  
...
wrapr::build_frame(
  ...
  kbl(align = "ll", col.names = NULL) |>
  kable_paper(lightable_options = "basic", 
              full_width = TRUE, 
              font_size = 24) |>
  column_spec(2, color = "black", background = "white") |>
  column_spec(1, color = "black", background = "white") |>
  row_spec(c(1, 4), bold = TRUE, color = "#01665e", background = "#c7eae5")
```

<br>

*variables $\rightarrow$ chart design  $\rightarrow$  message $\rightarrow$ research question  $\rightarrow$ variables $\rightarrow$ chart design  $\rightarrow$  message $\rightarrow$ ...*
...
1. Time (discrete years) is a **categorical variable**.
...
4. The independent variable is  `___________________________`
...
<img src="img/boxplot-preview-2.png" alt="stacked bar preview" style="height:250px;">
]
