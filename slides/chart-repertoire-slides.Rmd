---
title: "Expanding your graphgical repertoire"
output:
...
.pull-left[
```{r}
options(datatable.print.topn = 19)
...
q <- p + geom_path(linetype = 2, size = 0.5)
q
